...
from pdf_group.page_funcs import (
    BLOCK_R,
    BLOCK_G,
    BLOCK_B,
    MIN_SCALE_DELTA_Y,
...
def page(pdf, square_results, lang):
    ...
    block_name_(
        pdf, BLOCK_R, BLOCK_G, BLOCK_B, start_block_name_y, x, "КОМАНДНАЯ УСТОЙЧИВОСТЬ"
    )
    ...
    block_name_(
        pdf, BLOCK_R, BLOCK_G, BLOCK_B, start_block_name_y, x, "УСТОЙЧИВОСТЬ РЕЗУЛЬТАТА"
    )
