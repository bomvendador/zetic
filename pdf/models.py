...
class PointDescription(models.Model):
    ...
    text_en = models.TextField(
        default=None, blank=True, null=True, verbose_name="Английский"
    )

    def __str__(self):
        if self.text_en == "":
            return "Англ отсутсвует"
        else:
...
class EmployeeRole(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        on_delete=models.PROTECT,
        related_name="Создано_пользователем_роль_сотрудника",
    )
    edited_at = models.DateTimeField(auto_now=True, null=True)
    edited_by = models.ForeignKey(
        User,
        ...
        null=True,
        on_delete=models.PROTECT,
        related_name="Изменено_пользователем_роль_сотрудника",
    )
    name_ru = models.CharField(max_length=100, blank=True, null=True)
    name_en = models.CharField(max_length=100, blank=True, null=True)
    public_code = models.CharField(max_length=10, blank=True, null=True, default="")
...
class EmployeeGender(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        on_delete=models.PROTECT,
        related_name="Создано_пользователем_пол_сотрудника",
    )
    edited_at = models.DateTimeField(auto_now=True, null=True)
    edited_by = models.ForeignKey(
        User,
        ...
        null=True,
        on_delete=models.PROTECT,
        related_name="Изменено_пользователем_пол_сотрудника",
    )
    name_ru = models.CharField(max_length=100, blank=True, null=True)
    name_en = models.CharField(max_length=100, blank=True, null=True)
    public_code = models.CharField(max_length=10, blank=True, null=True, default="")
...
class StudyQuestionGroup(models.Model):
    study = models.ForeignKey(
        Study, on_delete=models.CASCADE, default=None, null=True, blank=True
    )
    section = models.ForeignKey(
        Section, on_delete=models.CASCADE, default=None, null=True, blank=True
    )
...
class ParticipantQuestionGroups(models.Model):
    ...
    question_group_name = models.CharField(
        max_length=30, blank=True, null=True, default=None
    )
    question_group_code = models.CharField(
        max_length=3, blank=True, null=True, default=None
    )
    participant = models.ForeignKey(
        Participant, on_delete=models.CASCADE, default=None, null=True, blank=True
    )
...
class EmailSentToParticipant(models.Model):
    ...
    participant = models.ForeignKey(
        Participant, on_delete=models.CASCADE, default=None, null=True
    )
...
class RawToTPoints(models.Model):
    type = models.ForeignKey(
        RawToTPointsType, on_delete=models.CASCADE, default=None, blank=True, null=True
    )
...
class ReportGroup(models.Model):
    ...
    comments = models.TextField(
        default=None, blank=True, null=True, verbose_name="Комментарии групповой отчет"
    )
...
class ReportGroupSquare(models.Model):
    ...
    square_name = models.CharField(
        max_length=30, blank=False, null=False, verbose_name="Квадрат"
    )
    report = models.ForeignKey(
        Report,
        on_delete=models.CASCADE,
    ...
    participant_group_color = models.CharField(
        max_length=20,
        blank=True,
        null=True,
        verbose_name="Цвет группы участника",
        default=None,
    )
