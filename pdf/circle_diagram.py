...
def page_circle_diagram(pdf, questionnaire_id, report_id, lang):
    ...
    pdf.set_draw_color(0, 0, 0)
    pdf.line(x + 1, y + 5, x + 220, y + 5)
    text = u'Потенциал - совокупность особых способностей и лисночтных качеств, позвлояющих эффективно справляться с рабочими ' \
           u'задачами и прогнозировать успех челоовека в ситуации изменений '
